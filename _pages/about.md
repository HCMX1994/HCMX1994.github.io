...
Dr. Liu was a recipient of the [Best Student Paper Award](https://www.kent.ac.uk/engineering-and-digital-design/news/3305/best-student-paper-prizes) at the 17th International Workshop on Antenna Technology (iWAT 2022), Dublin, and the Outstanding Academic Achievement for his M.S. program. He received the [Young Scientist Award](https://www.kent.ac.uk/engineering-and-digital-design/news/3340/school-of-engineering-phd-student-xuekang-liu-wins-international-award) from the International Union of Radio Science (URSI) Member Committee, Germany, in 2022.

He actively contributes as a reviewer for more than ten prestigious international journals, including [IEEE Transactions on Instrumentation and Measurement](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=19), [IEEE Transactions on Antennas and Propagation](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=8), [IEEE Antennas and Wireless Propagation Letters](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7727), [Nature Scientific Reports](https://www.nature.com/srep/), and [IET Microwaves, Antennas & Propagation](https://digital-library.theiet.org/content/journals/iet-map). Additionally, he serves as an International Program Committee Member for the [European Conference on Antennas and Propagation (2025)](https://www.eucap2025.org/), the [International Conference on AI in Healthcare (2024)](https://aiih.cc/), and the [United Conference on Millimetre Waves and Terahertz Technologies (2024)](https://www.ucmmt2024.org/).
...
Postdoctoral Researcher (Full-time) -[Imperial College London](https://www.imperial.ac.uk/), UK (Jun 2025-Present) 
------
...
- A sub-THz (W-band) communication system is developed.
- Successfully developed a range of single-beam and multi-beam dielectric lens antennas, compatible with 3D printing and CNC machining technologies.
