...
<div class="footer note"><p>Source: Umami · Recording began 24 September 2026. These are manually imported snapshots, not a live counter. Earlier MapMyVisitors records are maintained separately and are not added to these totals. Setup and VPN test visits are included.</p><p><a href="/">Back to the homepage</a></p></div>
